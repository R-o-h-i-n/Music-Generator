            ...
            >
                ...
                <TabsContent value="simple" className="mt-6 space-y-6">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="w-full overflow-x-aud whitespace-nowrap">
                ...
                <TabsContent value="custom" className="mt-6 space-y-6">
                    <div className="flex flex-col gap-3">
                        ...
                        <Textarea 
                            placeholder={lyricsMode === "write" ? "Write your own lyrics here..." : "AI will generate lyrics for your song based on your description..."}
                            value={lyrics} 
